                ...
                .map((item)=>(
                  <div className="" key={item.id}>
                    ...
                    <div className=" text-xl text-center">
                      ...
                      <p className=" font-bold opacity-80">{item.price}</p>
                    </div>
                    <div className="flex justify-center mt-2">
                      <button className=" bg-black text-white font-semibold px-6 py-2 hover:scale-105 ">Add To Cart</button>
                    </div>
                  </div>
                ))}
              </div>
