...
export default function Sales() {
  ...
  const currentData = saleData.slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);
      ...
      <div className=" bg-gray-200">
        <div className={paddingForpage}>
          <div className="">
            <div className="">
              ...
              <div className=" font-medium ">
                <p className=" font-semibold text-xl">
                  Sale Valid till:
                  <span className="text-red-500"> April 30, 2026</span>
                </p>
            ...
            <div className=" mt-5">
              <Link href="/dress">
                <Image width={40} height={40} className="w-7 aspect-square object-cover object-center" src="/icons/backbtn.png" alt="" />
              </Link>
            </div>
            <div className=" my-10">
              {isDataLoading ? (
