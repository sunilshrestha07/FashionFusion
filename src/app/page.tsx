        ...
        <div className=" w-full aspect-[9/12] sm:aspect-[15/11] md:aspect-[15/10] lg:aspect-[15/7] object-cover overflow-hidden relative">
          ...
          >
            ...
            <div className=" sm:text-base xl:text-xl w-11/12 sm:w-2/4 xl:w-2/5">
              <p>
                Our online store offers a wide selection of premium quality clothes that are designed to keep you comfortable and stylish. Browse our
                collection and find the perfect clothes that suits your style and needs.
              </p>
            </div>
